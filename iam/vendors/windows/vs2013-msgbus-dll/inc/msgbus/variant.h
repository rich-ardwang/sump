...
public:
    ...
    /*
        push_back函数兼容std::list<Variant>，请避免使用
    */
...
public:
    ...
    */
    ...
    inline bool getFieldInfo(int index, std::string &name, int &type) const {return GetFieldInfo(index , name , type) ;}
