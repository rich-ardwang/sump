...
enum AmqpConstant {
    ...
    CLUSTER_CONNECTION_DTX_START_METHOD_ID=0x1A,
    CLUSTER_CONNECTION_DTX_END_METHOD_ID=0x1B,
    CLUSTER_CONNECTION_DTX_ACK_METHOD_ID=0x1C,
    CLUSTER_CONNECTION_DTX_BUFFER_REF_METHOD_ID=0x1D,
    CLUSTER_CONNECTION_DTX_WORK_RECORD_METHOD_ID=0x1E,
    ...
    CLUSTER_CONNECTION_QUEUE_FAIRSHARE_STATE_METHOD_ID=0x38,
    CLUSTER_CONNECTION_QUEUE_OBSERVER_STATE_METHOD_ID=0x39,
    CLUSTER_CONNECTION_CLOCK_METHOD_ID=0x40,
    CLUSTER_CONNECTION_QUEUE_DEQUEUE_SINCE_PURGE_STATE_METHOD_ID=0x41
};
