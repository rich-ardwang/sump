...
public:
    ...
    inline const std::string& GetBusinessID() const {return business_id_;}
    inline void SetBusinessID(const std::string& id) {business_id_ = id;}

    inline const std::string& GetBusinessSeq() const {return business_seq_;}
    inline void SetBusinessSeq(const std::string& seq) {business_seq_ = seq;}

    inline const std::string& GetBusinessTime() const {return business_time_;}
    inline void SetBusinessTime(const std::string& time) {business_time_ = time;}
    ...
    bool UpdateUInt8(const char *name, uint8_t value);
    bool UpdateUInt16(const char *name, uint16_t value);
    bool UpdateUInt32(const char *name, uint32_t value);
    bool UpdateUInt64(const char *name, uint64_t value);
    bool UpdateInt8(const char *name, int8_t value);
    bool UpdateInt16(const char *name, int16_t value);
    bool UpdateInt32(const char *name, int32_t value);
    bool UpdateInt64(const char *name, int64_t value);
    bool UpdateFloat(const char *name, float value);
    bool UpdateDouble(const char *name, double value);
    bool UpdateString(const char *name, const std::string& value);
...
private:
    ...
    std::string business_seq_ ;
    std::string business_time_ ;
