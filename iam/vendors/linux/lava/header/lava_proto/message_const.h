...
#define MSG_TYPE_STREAM_PUB		0x5F	// 新增加为DDS
#define MSG_TYPE_DATA_HTTP		0x60	// HTTP消息
#define MSG_TYPE_DATA_PUB		0x61	// 广播消息
#define MSG_TYPE_DATA_REQ		0x62	// 请求消息
#define MSG_TYPE_DATA_REPLY		0x63	// 回应消息
#define MSG_TYPE_DATA_P2P		0x64	// 点对点消息
#define MSG_TYPE_DATA_PUB_GROUP	0x65	// publish group消息
#define MSG_TYPE_CODE_REQ		0x66	// 新版： 请求消息
#define MSG_TYPE_CODE_REPLY		0x67	// 新版： 回应消息

#define WEBSOCKET_BIN			0x82

#define FUN_CODE_SUB			0x1		// 功能号 stream订阅消息
#define FUN_CODE_REQ			0x2		// 功能号 请求消息
