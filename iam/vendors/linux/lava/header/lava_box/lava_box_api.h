...
lava_box_api lava::proto::i_message* create_message(uint8_t type);
...
lava_box_api lava::base::i_auto_ptr<lava::box::i_stub> create_stub_for_java(__lv_in const char* server_name_, __lv_in lava::comm::i_server_listener* listener, __lv_in const char* host_, __lv_in const char* port_);

lava_box_api lava::base::i_auto_ptr<lava::box::i_stub> create_stub_for_java(__lv_in const char* server_name_, __lv_in lava::comm::i_server_listener* listener, __lv_in const char* host_, __lv_in const char* port_, __lv_in const char* cluster_server_info, __lv_in const char* server_name, __lv_in lava::comm::lava_service_type server_type);